...
const initialImageProps: ImageProps = {
    ...
    footerFontSize: 10,
    receiveAddress: '',
    config: { ...imagesConfig[ImageType.Sticker] },
    overlay: false,
...
export const ImageCreator = () => {
    ...
    const cardHTML = () => (
        <React.Fragment>
            ...
            <Card ref={imageRef as any} sx={{
                width: `${80 * getScale()}%`,
                height: `${imageProps.config.format[0]/imageProps.config.format[1]*((imageRef.current?.offsetWidth || 0))}px`,
                ...
                backgroundPositionY: imageProps.type === ImageType.Bookmark ? '2in' : '0',
                backgroundPosition: crop && `${-crop.x}px ${-crop.y}px` || '0px 0px',
                borderRadius: '0px'
            }}>
                <CardActionArea sx={{
                    ...
                    justifyContent: imageProps.type === ImageType.BusinessCard ? 'center' : 'flex-start' }}
                >
                    ...
                    <CardContent sx={{ display: 'flex', justifyContent: 'center' }}>
                        <Typography
                            sx={{
                                fontSize: `${imageProps.sloganFontSize * getScale()}px`,
                                color: imageProps.sloganColor,
                                maxWidth: `${(imageProps.config.format[0] - 0.5)/imageProps.config.format[0]*100}%`,
                ...
                <Stack spacing={3}>
                        ...
                        <FormControl>
                            ...
                            <RadioGroup
                                ...
                                onChange={(event)  => {
                                    ...
                                    setImageProps({
                                        ...imageProps,
                                        type: event.target.value as ImageType,
                                        // copies: 1
                                    })
                                }}
                                name="cardType"
                    ...
                    <React.Fragment>
                        ...
                        <Item>
                            ...
                            <Button
                                ...
                                color="warning"
                                sx={{ marginLeft: '1em' }}
                                disabled={imageProps.mainImage === null}
                                onClick={() => {
                                    setImageProps({
                                        ...imageProps,
                                        mainImage: null
                    ...
                    <Item>
                        ...
                        <Button
                            ...
                            variant="contained"
                            color="warning"
                            disabled={imageProps.backgroundImage === null}
                            onClick={() => {
                                setImageProps({
                                    ...imageProps,
                                    backgroundImage: null
                    ...
                    <Item>
                        { (imageProps.type === ImageType.Sticker) &&
                        <React.Fragment>
                            <Item>
                                <FormLabel id="cardPrimaryTextColor">
