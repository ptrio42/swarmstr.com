...
export const PageContent = () => {
    return (
      <Box sx={{ width: '80%', margin: '0px auto', marginTop: '2em' }}>
          ...
          <Typography id="let-s-shame-someone" variant="h3" component="div" gutterBottom sx={{ marginTop: '3em' }}>
              Let's shame someone!
          </Typography>
          <Typography variant="body1" component="div" align="justify" gutterBottom sx={{ lineHeight: '2', fontSize: '18px' }}>
          ...
          <List>
              <ListItem>
                  ...
                  <a className="link" href={ process.env.PUBLIC_URL + '/pdfs/en-uselessshit-card-front.pdf'} target="_blank">
                    <ListItemText primary="Useless Shit Card Front" />
                  </a>
              </ListItem>
              <ListItem>
                  <Bolt />
                  <a className="link" href={ process.env.PUBLIC_URL + '/pdfs/en-uselessshit-card-back.pdf'} target="_blank">
                    <ListItemText primary="Useless Shit Card Back" />
                  </a>
              </ListItem>
          </List>
          <Typography id="credits" variant="h3" component="div" gutterBottom sx={{ marginTop: '3em' }}>
              Credits
          </Typography>
          <Typography variant="body1" component="div" align="justify" gutterBottom sx={{ lineHeight: '2', fontSize: '18px' }}>
              This project was VERY HEAVILY inspired by <a className="link" href="https://dergigi.com" target="_blank">@gigi</a>'s <a className="link" href="https://www.fuckingshitcoins.com" target="_blank">www.fuckingshitcoins.com</a>, which is a VERY SERIOUS campaign to shame merchants into adopting bitcoin.
          ...
          {/*<Typography variant="h3" component="div" gutterBottom sx={{ marginTop: '3em' }}>*/}
              {/*Testimonials*/}
          {/*</Typography>*/}
          {/*<Typography variant="body1" component="div" align="justify" gutterBottom sx={{ lineHeight: '2', fontSize: '18px' }}>*/}
              {/*My pal went shopping to buy shorts but came back with two pairs, additional two pairs of trousers and four t-shirts.*/}
              ...
              {/*That's when I realized it wasn't Satoshi speaking to me, but rather a scream of missed opportunity.*/}
              ...
              {/*Now I carry witch me at least a dozen of the useless-shit cards and whenever someone makes a dumb purchase, I am prepared!*/}
              {/*Thanks uselessshit.co!*/}
          {/*</Typography>*/}
      </Box>
    );
};