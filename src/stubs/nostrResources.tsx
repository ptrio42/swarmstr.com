...
export const GUIDES: Guide[] = [
    ...
    },
    {
        ...
        bulletPoints: [
            ...
            'npub13prsf02zzus79yhdhl6zadm4gllpzhr0lxp9kz8uxe47fntfa8mqyrh6a9:0xtlt',
            'https://github.com/0xtlt/',
            'npub1jutptdc2m8kgjmudtws095qk2tcale0eemvp4j2xnjnl4nh6669slrf04x:BenGWeeks',
            'https://github.com/BenGWeeks',
            'npub146e625cxmwc93c8jpw5p0slkrna4t0j3lmzu94g07tkrrqg0staqjup4e0:sdub',
            'https://github.com/sdub18',
            'npub1yaul8k059377u9lsu67de7y637w4jtgeuwcmh5n7788l6xnlnrgs3tvjmf:tyiu',
            'https://github.com/tyiu',
            'npub107e29x735swe4r9y8gv60h8n4pfz7x7qndqgvff48yvsa8pfc5dq3p0cr5:olegaba',
            'https://github.com/OlegAba',
            'npub19a86gzxctwtz68l8zld2u9y2fjvyyj4juyx8m5geylssrmfj27eqs22ckt:Klabo',
            'https://github.com/joelklabo/',
            'npub1uqeexjx2djkfwzxdnrnrrch5h2k4xn0uapcgsxm94ftaxrlhy5lqywjckg:jsm',
            'https://github.com/realprogrammersusevim',
            '#### nostream, SMTP Nostr Gateway, Tnsor',
            'npub1qqqqqqyz0la2jjl752yv8h7wgs3v098mh9nztd4nr6gynaef6uqqt0n47m:cameri',
            'https://github.com/cameri',
            '#### iris.to',
            'npub1g53mukxnjkcmr94fhryzkqutdz2ukq4ks0gvy5af25rgmwsl4ngq43drvk',
            'https://github.com/mmalmi',
            '#### yosupp.app',
            'npub1klrxeehhh0srf6ttu4xzllq2ma334zy6hsyrfws5xyt3ke7y3x4qze9lh3:Thomas',
            'https://github.com/tmathews',
            'https://git.sr.ht/~tomtom/damus',
            '#### astral.ninja',
            'npub13sx6fp3pxq5rl70x0kyfmunyzaa9pzt5utltjm0p8xqyafndv95q3saapa:monlovesmango',
            ...
            '#### snort.social',
            'npub1v0lxxxxutpvrelsksy8cdhgfux9l6a42hsj2qzquu2zk7vc9qnkszrqj49:Kieran',
            'https://github.com/v0l',
            'npub107jk7htfv243u0x5ynn43scq9wrxtaasmrwwa8lfu2ydwag6cx2quqncxg:verbicha',
            ...
            '#### Amethyst App',
            'npub1gcxzte5zlkncx26j68ez60fzkvtkm9e0vrwdcvsjakxf9mu9qewqlfnj5z:vitorpamplona',
            'https://github.com/vitorpamplona',
            '#### Bija',
            'npub1qqqqqqqut3z3jeuxu70c85slaqq4f87unr3vymukmnhsdzjahntsfmctgs:CarlosAutonomous',
            'https://github.com/BrightonBTC',
            '#### Daisy',
            'npub1e0usfsrs9gmpjywyd4un0xn22q4u80gtf3tdy5ufuckna0620kuq5w732v:neb_b',
            'https://github.com/neb-b',
            '#### hamstr.to',
            'npub1duedmhed2nevtejwz4c2hjuu0gz7spqm4s8wnaprta55ln9k3dwssvgpq4:styppo',
            'https://github.com/styppo',
            '#### nostrid.app',
            'npub14uc57wfq2zd0g3qh5lpvkq2svvkjl9fruzyxnz9zh95ev2japw7ql2g0sq:lapulpeta',
            'https://github.com/lapulpeta',
            '#### nostros',
            'npub1v3tgrwwsv7c6xckyhm5dmluc05jxd4yeqhpxew87chn0kua0tjzqc6yvjh:KoalaSat',
            'https://github.com/KoalaSat',
            '#### nostr.console',
            'npub1xg6sx67sj47lkf7vmgpdg5khca3musxfrgdvpq46dxpmy53c8zxqqy7kwr:vishalxl',
            'https://github.com/vishalxl',
            'npub14j0vqgqhq92lpl4nglcdwalwtlpcm50nvdfsjvzxxgmydnl4z60sdv04f4:radixrat',
            'https://github.com/radixrat/',
            '#### Coracle',
            'npub1jlrs53pkdfjnts29kveljul2sm0actt6n8dxrrzqcersttvcuv3qdjynqn:hodlbod',
            'https://github.com/staab/coracle',
            '####  Blockcore Notes',
            'npub1zl3g38a6qypp6py2z07shggg45cu8qex992xpss7d8zrl28mu52s4cjajh:sondreb',
            'https://github.com/sondreb',
            '#### nostroid',
            'npub1gm7tuvr9atc6u7q3gevjfeyfyvmrlul4y67k7u7hcxztz67ceexs078rf6:Giszmo',
            'https://github.com/Giszmo',
            '#### nostriushand',
            'npub1axvv6p3e6qt8ldca8lxpc9qdccjp7degsn2l6vqthmy4ugrpvw6s63ksnl:Tertiushand',
            'https://github.com/tertiushand',
            '#### gossip',
            'npub1acg6thl5psv62405rljzkj8spesceyfz2c32udakc2ak0dmvfeyse9p35c:MichaelDilger',
            'https://github.com/mikedilger',
            '#### nostrimg.com',
            'npub1xv6axulxcx6mce5mfvfzpsy89r4gee3zuknulm45cqqpmyw7680q5pxea6:henry',
            ...
            '#### alphaama',
            'npub1nmr6w7qk0ta36vxysv77jv3d5rqghfc6d8sez8240rf3gja4vsmsd2yha8:balas',
            'https://github.com/eskema',
            '#### nostr.lib / client',
            'npub1qqqqq2z444usdf6k306djuwcyptfjj4x0teu7qzg4qj5zkkfqeeq3hlwh5:Sgiath',
            'https://github.com/Sgiath',
            '#### nostr-lib',
            'npub1alyr7qwglvcfmukgse4cc7fyej9k7pvq4lw7r4hpdc4kzp7zsckqmy0qkx:roosoft',
            'https://github.com/RooSoft',
            '#### nostr-rs-relay',
            'npub1xhfxu35se0s63x90v8xr29txr66l5a3m277skshy2zvu3ve0658sla4xw3:scsibug',
            'https://github.com/scsibug',
            '#### nostr-rs-sdk',
            'npub1drvpzev3syqt0kjrls50050uzf25gehpz9vgdw08hvex7e0vgfeq0eseet:yuki',
            'https://github.com/yukibtc',
            '#### nostr-ruby',
            'npub10000003zmk89narqpczy4ff6rnuht2wu05na7kpnh3mak7z2tqzsv8vwqk:dtonon',
            'https://github.com/dtonon',
            '#### Lee Salminen',
            'npub1taycl7qfuqk9dp0rhkse8lxhz3az9eanjug8j4ympwehvslnetxqkujg5y:lee',
            'https://github.com/leesalminen',
            '#### emon.chat',
            'https://github.com/SebastiaanWouters',
            '#### nostr-relay',
            'npub14lu6nuqh7v4jazmqw49yzqkmnkw0nletjeuqfdgwqurcp2j9ex5qz37m8m:aaron',
            ...
            'npub1qv0nc6gxr80sgredulxm7g6zm6z9gp4ns9nudq6mfxq0ed87gsnq7wswaz:BitcoinImagined',
            '#### nostr.band',
            ...
            '#### nostr.directory',
            'npub1xhe9408d5hm3dpwax78sy9nuc5warycnvcy4r3qzv6jacwu26r6s5m56yf',
            'https://github.com/pseudozach',
            '#### orangepill.dev',
            'npub16jzr7npgp2a684pasnkhjf9j2e7hc9n0teefskulqmf42cqmt4uqwszk52:ezofox',
    ...
    },
    {
        ...
        bulletPoints: [
            ...
            'Tag npub1gl23nnfmlewvvuz7xgrrauuexx2xj70whdf5yhd47tj0r8p68t6sww70gt:bitcoinbull',
