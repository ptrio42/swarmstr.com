...
export const GUIDES: Guide[] = [
    ...
    },
    {
        ...
        bulletPoints: [
            ...
            'https://uploads-ssl.webflow.com/63c880de767a98b3372e30e7/63cbd11c0760e781e92bbd03_Take%20Both%20Pills-p-1600.png',
            'HELLO! WELCOME TO #NOSTR(land)',
            'Here is my daily update #Nostr sources\' list for new users. Probably you know already many of them, but maybe you will find somethng new I added TODAY.. at least a new amazing cover image (from Nostrland).',
            'Thank you if you consider repostig it; also do comment below with new info or sources if you have.',
            ...
            'https://nostr.band',
            'If you want to upload free image on a note:',
            'https://nostr.build',
            'If you want to upload gif on a note:',
            'https://tenor.com/',
